...
const App = () => {
    ...
    async function postData2() {
        ...
        const result = await fetch('http://localhost:50424/api/Default/Add_Transcation_Test', { headers: { 'Content-Type': 'application/json' }, method: "POST", body: JSON.stringify(arr) })
